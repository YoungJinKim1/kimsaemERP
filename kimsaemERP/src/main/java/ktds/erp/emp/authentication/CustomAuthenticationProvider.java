...
public class CustomAuthenticationProvider implements AuthenticationProvider{
	...
	public Authentication authenticate(Authentication data) throws AuthenticationException {
		...
		//UserDetailsService의 loadUserByUsername을 호출하여 DB에서 조회한 데이터와 인증할 수 있도록 한다.
		...
		boolean state = ShaPasswordEncoder.isPasswordValid(loginUser.getPass(), pass, loginUser.getId());
	...
	//로그인 아이디와 패스워드를 이용해서 인증하려면 supports가 true를 리턴해야 한다.
